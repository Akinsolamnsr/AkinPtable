...
import { Spdf, spdfRaw } from "../../../Const"
...
"7p¹,112","7p²,113","7p³,114","7p⁴,115","7p⁵,116","7p⁶,117",
    ...
    ConfigList2.forEach((data,i,x) => {
        ...
        names.push(<span key={`spdfMid${i}4s`} className={`${spdfRaw[count].includes(i)?"":"hidden"}`}><SpdfDrop accept={data} count={count} cont={x[count]} pos={pos1} numb={`${i}`} /></span>)
      })
