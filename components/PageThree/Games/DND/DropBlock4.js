...
return (
  ...
  ${status?`${Block==="s"?"text-[#002933] bg-[#005266] border-4 border-[#4ddbff] ":`${Block==="p"?"bg-[#660029] border-4 border-[#ff80b3]":`${Block==="d"?"bg-[#004d1a] border-4 border-[#80ffaa]":"bg-[#330033] border-4 border-[#ff80ff]"}`}`}`:"border border-blue-400"}
  `}  ref={drop}>  
