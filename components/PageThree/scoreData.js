...
const MapData=data.map((x,i)=>{
  ...
  return (
    <div  className="w-full h-full  flex flex-col shadow-xl">
        ...
        {MapData.sort((x,y)=>y[1]-x[1]).map((x,i)=>(<div key={`bestScore${i}`} className="mt-1 flex bg-[#e6faff] text-[#00141a] text-[0.7rem] font-semibold"><span className="basis-[15%]">{i+1}</span><span className="basis-[50%]">{x[0]}</span><span className="basis-[35%] ">{x[1]}</span></div>))}
        </div>
        </div>
        ...
        <div className={`${swtch==="1"?"":"hidden"} ${MaxSize?"h-[10rem] text-[0.7rem]":"h-[17rem]"}  mr-1 ml-1 flex flex-col`}>
            ...
            <div>
                {swtch2==="1"?<div className=" h-[18rem]  overflow-y-auto">{data.sort((y,x)=>x.Games.Arrange.fst-y.Games.Arrange.fst).map((x,i)=>(<div key={`AScoreT${i}`} className="mt-1 flex bg-[#e6faff] text-[#00141a] text-[0.7rem] font-semibold"><span className="basis-[15%]">{i+1}</span><span className="basis-[50%]">{x.name}</span><span className="basis-[35%] ">{msToTime(x.Games.Arrange.fst)}</span></div>))}</div>:
                swtch2==="2"?<div className=" h-[18rem]  overflow-y-auto">{data.sort((y,x)=>x.Games.Arrange.scd-y.Games.Arrange.scd).map((x,i)=>(<div key={`AScoreF${i}`} className="mt-1 flex bg-[#e6faff] text-[#00141a] text-[0.7rem] font-semibold"><span className="basis-[15%]">{i+1}</span><span className="basis-[50%]">{x.name}</span><span className="basis-[35%] ">{msToTime(x.Games.Arrange.scd)}</span></div>))}</div>:
                <div className=" h-[18rem]  overflow-y-auto">{data.sort((y,x)=>x.Games.Arrange.thd-y.Games.Arrange.thd).map((x,i)=>(<div key={`AScoreA${i}`} className="mt-1 flex bg-[#e6faff] text-[#00141a] text-[0.7rem] font-semibold"><span className="basis-[15%]">{i+1}</span><span className="basis-[50%]">{x.name}</span><span className="basis-[35%] ">{msToTime(x.Games.Arrange.thd)}</span></div>))}</div>
                }
            </div>
        </div>
        </div>
        ...
        <div className={`${swtch==="4"?"":"hidden"} ${MaxSize?"h-[10rem] text-[0.7rem]":"h-[17rem]"}  mr-1 ml-1 flex flex-col`}>
            <div className="flex justify-between "><button onClick={()=>setSwtch2("1")} className={`${swtch2==="1"?"text-cyan-700 font-bold":"bg-green-200  border-2 text-green-700 font-bold"} w-full `}>Twenty</button><button onClick={()=>setSwtch2("2")} className={`${swtch2==="2"?"text-cyan-700 font-bold":"bg-green-200 border-2  text-green-700 font-bold"} w-full`}>Forty</button><button onClick={()=>setSwtch2("3")} className={`${swtch2==="3"?"text-cyan-700 font-bold":"bg-green-200 border-2  text-green-700 font-bold"} w-full`}>Full</button></div>
            <div>
            {swtch2==="1"?<div className=" h-[18rem]  overflow-y-auto">{data.sort((y,x)=>x.Games.Configuration.fst-y.Games.Configuration.fst).map((x,i)=>(<div key={`ConcoreT${i}`} className="mt-1 flex bg-[#e6faff] text-[#00141a] text-[0.7rem] font-semibold"><span className="basis-[15%]">{i+1}</span><span className="basis-[50%]">{x.name}</span><span className="basis-[35%] ">{msToTime(x.Games.Configuration.fst)}</span></div>))}</div>:
                swtch2==="2"?<div className=" h-[18rem]  overflow-y-auto">{data.sort((y,x)=>x.Games.Configuration.scd-y.Games.Configuration.scd).map((x,i)=>(<div key={`ConcoreF${i}`} className="mt-1 flex bg-[#e6faff] text-[#00141a] text-[0.7rem] font-semibold"><span className="basis-[15%]">{i+1}</span><span className="basis-[50%]">{x.name}</span><span className="basis-[35%] ">{msToTime(x.Games.Configuration.scd)}</span></div>))}</div>:
                <div className=" h-[18rem]  overflow-y-auto">{data.sort((y,x)=>x.Games.Configuration.thd-y.Games.Configuration.thd).map((x,i)=>(<div key={`ConcoreA${i}`} className="mt-1 flex bg-[#e6faff] text-[#00141a] text-[0.7rem] font-semibold"><span className="basis-[15%]">{i+1}</span><span className="basis-[50%]">{x.name}</span><span className="basis-[35%] ">{msToTime(x.Games.Configuration.thd)}</span></div>))}</div>
                }
            </div>
        </div>
        </div>
        ...
        <div className=" h-[18rem]  overflow-y-auto">{data.sort((y,x)=>x.Games.Block.pos-y.Games.Block.pos).map((x,i)=>(<div key={`Elemcore${i}`} className="mt-1 flex bg-[#e6faff] text-[#00141a] text-[0.7rem] font-semibold"><span className="basis-[15%]">{i+1}</span><span className="basis-[50%]">{x.name}</span><span className="basis-[35%] ">{msToTime(x.Games.Block.pos)}</span></div>))}</div>
        </div>
        </div>
        ...
        <div className=" h-[18rem]  overflow-y-auto">{data.sort((y,x)=>x.Games.Family.pos-y.Games.Family.pos).map((x,i)=>(<div key={`Famcore${i}`} className="mt-1 flex bg-[#e6faff] text-[#00141a] text-[0.7rem] font-semibold"><span className="basis-[15%]">{i+1}</span><span className="basis-[50%]">{x.name}</span><span className="basis-[35%] ">{msToTime(x.Games.Family.pos)}</span></div>))}</div>
        </div>
        </div>
